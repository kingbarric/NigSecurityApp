...
import com.security.nexarssecurity.entities.Reports;
 ...
 */
@Stateless
@Path("com.security.nexarssecurity.entities.reports")
public class ReportsFacadeREST extends AbstractFacade<Reports> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Reports entity) {
        super.edit(entity);
    }
    ...
    public Reports find(@PathParam("id") Integer id) {
